...
Route::get('/tester', [App\Http\Controllers\HomeController::class, 'tester']);
...
Route::post('/addGragenLocation', [App\Http\Controllers\HomeController::class, 'addGragenLocation']);

Route::get('/collect/sensor/data', [App\Http\Controllers\HomeController::class, 'sensorData']);